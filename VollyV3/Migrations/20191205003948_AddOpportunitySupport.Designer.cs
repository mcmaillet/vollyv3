...
namespace VollyV3.Migrations
{
    ...
    [Migration("20191205003948_AddOpportunitySupport")]
    partial class AddOpportunitySupport
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VollyV3.Data.Application", b =>
                {
                    ...
                    b.Property<string>("VollyV3UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("VollyV3UserId");

                    b.ToTable("Applications");
                });

            modelBuilder.Entity("VollyV3.Data.ApplicationOccurrence", b =>
                {
            ...
            modelBuilder.Entity("VollyV3.Data.Community", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VollyV3.Data.Opportunity", b =>
                {
                    ...
                    b.Property<int?>("CreatedByUserOrganizationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CreatedByUserUserId", "CreatedByUserOrganizationId");
            ...
            modelBuilder.Entity("VollyV3.Data.Application", b =>
                {
                    ...
                    b.HasOne("VollyV3.Models.VollyV3User", "VollyV3User")
                        .WithMany()
                        .HasForeignKey("VollyV3UserId");
                });

            modelBuilder.Entity("VollyV3.Data.ApplicationOccurrence", b =>
                {
                    b.HasOne("VollyV3.Data.Application", "Application")
            ...
            modelBuilder.Entity("VollyV3.Data.Opportunity", b =>
                {
                    ...
                    b.HasOne("VollyV3.Data.Community", "Community")
                        .WithMany()
                    ...
                    b.HasOne("VollyV3.Models.Users.OrganizationAdministratorUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserUserId", "CreatedByUserOrganizationId");
                });
